...
2019-07-15: modified as to count PETs with diff of 1-2 bp also as redundant PETs.
"""
...
def getStat(f,dfilter=[80,140,180]):
    ...
    for i, line in enumerate(of):
        ...
        r = (line[0],m)
       # r = (line[0],s,e)
        if (r in uniques) or ((line[0],m+1) in uniques) or ((line[0],m-1) in uniques ) or ((line[0],m+2) in uniques) or ((line[0],m-2) in uniques) :
            continue
        uniques.add(r)
        d = e -s
        ds.append(d)
