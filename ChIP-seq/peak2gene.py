...
"""
peak2gene.py
2015-01-11: Suitable for seperated GTF files. Modified Gene Id. Small bug fixed
"""

__author__ = "CAO Yaqiang"
__date__ = "2014-09-29"
__modified__ = "2015-01-11"
__copyright__ = ""
__version__ = "0.1"
...
def main():
    ...
    fnOut = "ENCODE_mRNA_conserved.gmt"
    get_annotations(beds, fnOut, gtf)
    beds = glob.glob("../1.Classfiled_Merged/1.mergeReps/*.bed")
    fnOut = "ENCODE_mRNA_all.gmt"
    get_annotations(beds, fnOut, gtf)
    beds = glob.glob("../1.Classfiled_Merged/2.mergeFactors/*.bed")
    fnOut = "ENCODE_mRNA_factors.gmt"
    get_annotations(beds, fnOut, gtf)
    gtf = "genecode.v21.gtf"
    beds = glob.glob("../1.Classfiled_Merged/3.conservedFactors/*.bed")
    fnOut = "ENCODE_all_conserved.gmt"
    get_annotations(beds, fnOut, gtf)
    beds = glob.glob("../1.Classfiled_Merged/1.mergeReps/*.bed")
    fnOut = "ENCODE_all_all.gmt"
    get_annotations(beds, fnOut, gtf)
    beds = glob.glob("../1.Classfiled_Merged/2.mergeFactors/*.bed")
    fnOut = "ENCODE_all_factors.gmt"
    get_annotations(beds, fnOut, gtf)
