...
def getMergedSets(pattern="_-6_CD4_",skips = ["../3.peaks/WT_6_Th2_Neg_Rep1.narrowPeak","../3.peaks/WT_6_Th2_Neg_Rep2.narrowPeak"]):
    ...
    cmd = "/Users/caoyaqiang/Projects/2.AID_GangRen/0.packages/bedtools2/bin/multiIntersectBed -header -i %s -names %s > %s.txt "%(" ".join(fs)," ".join(names),pattern) # too big with meanless result
    print(cmd)
    os.system(cmd)
