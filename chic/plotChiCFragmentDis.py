...
def plotDis(pattern):
    ...
    for f in glob("*%s*.bedpe.gz"%pattern):
    ...
    pylab.savefig("%s_fragment_length_distribution.pdf"%pattern)


def main():
    for p in ["Runx1","Cbfb","MYH11","H3K27ac","H3K27me3","IgG"]:
        plotDis(p)
