...
#STAR = "/picb/molsysbio/usr/caoyaqiang/4.ENV/SG/sage-7.3-cyq/upstream/bio/STAR-2.5.2b/source/STAR"
#CHROM_SIZE = "/picb/molsysbio/usr/caoyaqiang/1.Projects/18/1.GenomeReference/1.hg38/1.hg38_Sequence/hg38.chrom.sizes"
#STAR_INDEX = "/picb/molsysbio/usr/caoyaqiang/1.Projects/18/1.GenomeReference/1.hg38/5.STAR_Index/1.75bp"
CHROM_SIZE = "/picb/molsysbio/usr/caoyaqiang/1.Projects/17.Alu/1.GenomeReference/3.mm10/1.mm10_Sequence/mm10.chrom.sizes"
#STAR_INDEX = "/picb/molsysbio/usr/caoyaqiang/1.Projects/17.Alu/1.GenomeReference/3.mm10/5.STAR_Index/2.100bp"
STAR_INDEX = "/picb/molsysbio/usr/caoyaqiang/1.Projects/17.Alu/1.GenomeReference/3.mm10/5.STAR_Index/3.newStar"
...
def prepare_fastq2(Fastq_Root="2.Fastq/", ):
    ...
    """
    fastqs = glob.glob(Fastq_Root + "*.fq.gz")
    #fastqs = glob.glob( Fastq_Root+"*.fastq" )
    data = {}
    for fq in fastqs:
        s = os.path.split(fq)[1]
