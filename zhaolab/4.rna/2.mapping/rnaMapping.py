...
#STAR_INDEX = "/home/caoy7/caoy7/Projects/0.Reference/2.mm10/6.10xReference/refdata-cellranger-mm10-3.0.0/star"
#STAR="/home/caoy7/caoy7/Packages/cellranger-3.1.0/STAR/5dda596/STAR"
#CHROM_SIZE = "/home/caoy7/caoy7/Projects/0.Reference/5.mm9/1.fa/mm9.chrom.sizes"
#STAR_INDEX = "/home/caoy7/caoy7/Projects/0.Reference/5.mm9/3.index/3.star/1.50bp"
STAR = "/home/caoy7/anaconda2/envs/ngs2/bin/STAR"
#human
CHROM_SIZE = "/home/caoy7/caoy7/Projects/0.Reference/1.hg38/1.fa/hg38.chrom.sizes"
STAR_INDEX = "/home/caoy7/caoy7/Projects/0.Reference/1.hg38/3.index/5.star/1.100bp"
...
def STAR_pileup(bam):
    ...
    if os.path.exists(prefix + "Signal.Unique.str1.out.bw") and os.path.exists(
        ...
        return
    cmd = "{STAR} --runMode inputAlignmentsFromBAM --runThreadN 5 --genomeDir {genomeDir} --genomeLoad LoadAndKeep --outFileNamePrefix {prefix} --outWigType bedGraph --outWigStrand Unstranded --outWigNorm RPM --inputBAMfile {bam}".format(STAR=STAR,
         genomeDir=STAR_INDEX, prefix=prefix, bam=bam)
    call_sys([cmd])
    """
...
def main():
    ...
    Parallel(n_jobs=7)(delayed(STAR_multiplemapping)(sample, fqs, mapping_Root)
    ...
    bams = glob("*/*out.bam")
    Parallel(n_jobs=10)(delayed(STAR_pileup)(bam) for bam in bams)
